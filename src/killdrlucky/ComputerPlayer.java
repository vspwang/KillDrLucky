...
public class ComputerPlayer extends Player {
  ...
  public String pickUp(String itemName, GameModelApi model) {
    // Computer player does not manually pick up items;
    // its behavior is handled by model.autoAction().
    return "Computer-controlled players act automatically.";
  }

  @Override
  public String lookAround(GameModelApi model) {
    // Computer-controlled players act automatically;
    // they do not explicitly look around.
    return "Computer-controlled players act automatically.";
  }
